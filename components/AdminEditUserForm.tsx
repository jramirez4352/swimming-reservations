...
import { adminUpdateUser } from "@/lib/actions/admin-users"
...
export function AdminEditUserForm({ userId, currentName, currentEmail, currentPhone, currentCity, currentAddress }: Props) {
    ...
    <form action={formAction} className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <Input id="phone" name="phone" type="tel" defaultValue={currentPhone ?? ""} placeholder="55 1234 5678" />
        </div>
        <div className="space-y-1">
          <Label htmlFor="city">Ciudad</Label>
          <Input id="city" name="city" defaultValue={currentCity ?? ""} placeholder="Ciudad de México" />
        </div>
      </div>
      <div className="space-y-1">
