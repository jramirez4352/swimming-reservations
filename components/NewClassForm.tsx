      ...
      <Card>
        ...
        <CardContent>
          ...
          <form action={action} className="space-y-4">
            ...
            {professors.length > 0 && (
              <div className="space-y-1">
                <Label htmlFor="instructorUserId">Asignar a profesor (opcional)</Label>
                <select
                  id="instructorUserId"
                ...
                <p className="text-xs text-muted-foreground">El profesor asignado podrá ver y editar esta clase en su panel.</p>
              </div>
            )}
            <div className="space-y-1">
