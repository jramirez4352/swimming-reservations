...
import { createProfesorClass } from "@/lib/actions/profesor-classes"
...
export function ProfesorNewClassForm({
  instructorName,
  levels,
}: {
  ...
  const [state, action, pending] = useActionState(createProfesorClass, null)
        ...
        <CardContent>
          ...
          <form action={action} className="space-y-4">
            <div className="space-y-1">
              ...
              <Input id="title" name="title" placeholder="Natación avanzada" required />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input value={instructorName} disabled className="bg-muted" />
              <p className="text-xs text-muted-foreground">La clase quedará asignada a tu nombre.</p>
            </div>
